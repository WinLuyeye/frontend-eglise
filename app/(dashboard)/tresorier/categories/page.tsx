...
export default function TresorierCategoriesPage() {
  ...
  const columns = [
    ...
    },
    {
      key: 'transactions',
      header: 'Transactions',
      cell: (c: any) => c._count?.transactions || 0,
    },
    {
      key: 'actions',
      header: 'Actions',
    ...
    <div className="space-y-6">
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">Gérez les catégories d'entrées et de sorties</p>
        </div>
        <Button onClick={() => {
          setEditingId(null)
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <Card className="p-4">
          <div className="mb-4 flex items-center space-x-2">
            ...
            <h3 className="font-semibold">Catégories d'entrées</h3>
        ...
        <Card className="p-4">
          <div className="mb-4 flex items-center space-x-2">
            ...
            <h3 className="font-semibold">Catégories de sorties</h3>
