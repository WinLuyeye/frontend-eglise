// app/(dashboard)/pasteur/page.tsx
'use client'
...
export default function PasteurDashboardPage() {
  ...
  const dashboardData = useMemo(() => {
    ...
    return {
      ...
      rapportsRecents: globalData?.rapportsRecents || []
    }
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        ...
        <div className="flex items-center space-x-3">
          ...
          <Button variant="outline" onClick={() => router.push('/pasteur/rapports')} className="dark:border-gray-700 dark:text-gray-300">
          ...
          <div className="space-y-3">
            {topDonateurs.length === 0 ? (
              <div className="flex h-32 flex-col items-center justify-center text-center">
                ...
                <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Aucun donateur</p>
              </div>
            ) : (
      ...
      <Card className="p-4 dark:bg-gray-900 dark:border-gray-800">
        <div className="mb-4 flex items-center justify-between">
          ...
          <Button variant="ghost" size="sm" onClick={() => router.push('/pasteur/rapports')} className="dark:text-gray-400 dark:hover:text-white">
            Voir tout
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {rapportsRecents.length === 0 ? (
            ...
            rapportsRecents.slice(0, 3).map((rapport) => (
              <div key={rapport.id} className="rounded-lg border p-3 hover:bg-gray-50 dark:border-gray-700 dark:hover:bg-gray-800/50">
