// app/(dashboard)/chef-departement/membres/[id]/page.tsx
'use client'
              ...
              {selectedMember.email && (
                <div className="flex items-center text-gray-600 dark:text-gray-300">
                  ...
                  <div>
                    ...
                    <p className="dark:text-white">{selectedMember.email}</p>
                  </div>
                </div>
              )}
              {selectedMember.telephone && (
                <div className="flex items-center text-gray-600 dark:text-gray-300">
                  ...
                  <div>
                    ...
                    <p className="dark:text-white">{formatPhoneNumber(selectedMember.telephone)}</p>
                  </div>
                </div>
              )}
