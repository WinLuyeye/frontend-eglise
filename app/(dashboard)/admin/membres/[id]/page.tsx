    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex space-x-2">
          <Button
            variant="outline"
            onClick={() => router.push(`/admin/membres/${selectedMember.id}/modifier`)}
          >
          ...
          <div className="flex-1">
            ...
            <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2">
              ...
              <div className="flex items-center text-gray-600">
                ...
                <div>
                  <p className="text-xs text-gray-500">Date d&ldquo;inscription</p>
      ...
      {/* Transactions du membre - CORRECTION ICI */}
      {selectedMember.transactions && selectedMember.transactions.length > 0 && (
        <Card className="p-6">
          <h3 className="mb-4 font-semibold text-gray-900">Transactions récentes</h3>
          <div className="space-y-3">
            {selectedMember.transactions.map((transaction: Transaction) => (
              <div key={transaction.id} className="flex items-center justify-between border-b pb-3 last:border-0">
                <div>
                  <p className="font-medium">{transaction.categorie?.nom || 'Transaction'}</p>
                  <p className="text-sm text-gray-500">{formatDate(transaction.dateTransaction)}</p>
                </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="w-full max-w-md rounded-lg bg-white p-6">
            ...
            <p className="mt-2 text-gray-600">
              Êtes-vous sûr de vouloir supprimer le membre &ldquo;{selectedMember.prenom} {selectedMember.nom}&ldquo; ?
            </p>
